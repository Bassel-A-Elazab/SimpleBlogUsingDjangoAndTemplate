'''
I get this script from the following Github repo.
https://github.com/maethor/avatar-generator
I copied the code from that repo because there is a problem according to load fonts in Django. 
It should be in a directory that's  Django can access.
'''
...
class Avatar(object):
    ...
    def _font(size):
        """
            ...
            :param size: size of the avatar, in pixels
        """
        path = os.path.join(Path(__file__).parent.parent, 'static/fonts',
                            "Inconsolata.otf")
