    ...
    def test_create_superuser(self):
        ...
        with self.assertRaises(ValueError):
            self.user.objects.create_superuser(
                email=self.user_email, name=self.user_name, password=self.user_password, is_superuser=False)
        with self.assertRaises(ValueError):
            self.user.objects.create_superuser(
                email=self.user_email, name=self.user_name, password=self.user_password, is_staff=False)
