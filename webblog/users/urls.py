...
from .views import BloggerDashboardView, BloggerListView, BloggerDetailView, BloggerUpdateView
...
urlpatterns = [
    ...
    path('bloggers/<int:pk>/dashboard', BloggerDashboardView.as_view(), name='blogger-dashboard'),
]