...
class BlogModelTests(TestCase):
    ...
    def test_description_label(self):
        ...
        actual_description_label = self.blog._meta.get_field("description").verbose_name
    ...
    def test_post_date_label(self):
        ...
        actual_post_date_label = self.blog._meta.get_field("post_date").verbose_name
    ...
    def test_uploaded_correct_cover_image_size(self):
        self.blog.cover = self.get_image_file("image.jpg", "png", (1024, 1024))
        self.blog.save()
    ...
    def test_uploaded_wrong_cover_image_size(self):
        cover_image = self.get_image_file("image.jpg", "png", (5096, 5096))
...
class BlogCommentModelTests(TestCase):
    ...
    def test_object_name_with_small_length(self):
        ...
        self.assertEqual(expected_object_name, str(self.blog_comment_one))

    def test_object_name_with_high_length(self):
        len_comment = 75
        expected_object_name = self.blog_comment_two.comment[:len_comment] + "..."
        self.assertEqual(expected_object_name, str(self.blog_comment_two))
    ...
    def test_blog_label(self):
        ...
        actual_blog_label = self.blog_comment_one._meta.get_field("blog").verbose_name
    ...
    def test_comment_date_label(self):
        ...
        self.assertEqual(actual_comment_date_label, expected_comment_date_label)
