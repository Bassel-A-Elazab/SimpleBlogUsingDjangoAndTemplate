...
from .views import BlogCreateView, BlogDeleteView, BlogListView, BlogDetailCommentView, BlogTagDetail, BlogTagList, BlogUpdateView
...
urlpatterns = [
    ...
    path('blog/<int:pk>/update', BlogUpdateView.as_view(), name='blog-new'),
